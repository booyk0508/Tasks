...
with sr.AudioFile("/content/AamirKhan_6.wav") as source:
...
translation = translator.translate("सर जी दरअसल हम हम अपनी अपनी जिंदगी में जी रहे हैं और जो हमारे मन पर किन चीजों का असर होता है हम टीवी पर न्यूज़")
